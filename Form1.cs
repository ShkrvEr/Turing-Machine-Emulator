    ...
    public partial class Form1 : Form
    {
        ...
        private void AcceptWord_Click(object sender, EventArgs e)
        {
            if (alphabet != "")
            {
                if (WordBox.Text != "")
                {
                    ...
                    //Проверка на соответствие слова алфавиту
                    /*bool breakflag = false, check = false;
                    for (int i = 0; i < word.Length; i++)
                    {
                        for (int j = 0; j < alphabet.Length; j++)
                        {
                            ...
                            {
                                MessageBox.Show("Несоответствие слова и алфавита!", "Ошибка!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                breakflag = true;
                                break;
                            }
                        }
        ...
        private void OneStep_Click(object sender, EventArgs e)
        {
            ...
            if (CurrentCommand != "" && CurrentCommand.Length == 4)
            {
                ...
                string CommandDirection = CurrentCommand[1].ToString();
                ...
                if (CommandDirection == "!")
                {
                    ...
                    Start.Enabled = false;
                    MessageBox.Show("Терминальное состояние!", "ИСПАААНЦЫ!", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                }
            }
